...
def open_history_window():
    ...
    Label(history_window, font=("Segoe UI", 18, "bold"), text="Row #:", bg="DeepSkyBlue2").grid(column=0, row=0, padx=1, pady=5)
    Label(history_window, font=("Segoe UI", 18, "bold"), text="Receipt #:", bg="DeepSkyBlue2").grid(column=1, row=0, padx=1, pady=5)
    Label(history_window, font=("Segoe UI", 18, "bold"), text="Customer Full Name:", bg="DeepSkyBlue2").grid(column=2, row=0, padx=1, pady=5)
    Label(history_window, font=("Segoe UI", 18, "bold"), text="Item Name:", bg="DeepSkyBlue2").grid(column=3, row=0, padx=1, pady=5)
    Label(history_window, font=("Segoe UI", 18, "bold"), text="Quantity Hired:", bg="DeepSkyBlue2").grid(column=4, row=0, padx=1, pady=5)
    ...
    if not hired_items:
        Label(history_window, text="No data to display.\nNeed Help? Use the Help button on the main window.", font=("Segoe UI", 20, "bold"), bg='red').grid(column=1, row=5, padx=5, pady=5, columnspan=5)
...
def print_hired_item_details():
    ...
    Label(main_window, font=("Segoe UI", 16, "bold"), text="Row #:", bg="DeepSkyBlue2").grid(column=0, row=10, padx=1, pady=5)  # Row # Heading
    Label(main_window, font=("Segoe UI", 16, "bold"), text="Receipt #:", bg="DeepSkyBlue2").grid(column=1, row=10, padx=1, pady=5) # Reciept # Heading
    Label(main_window, font=("Segoe UI", 16, "bold"), text="Customer Full Name:", bg="DeepSkyBlue2").grid(column=2, row=10, padx=1, pady=5) # Name Heading
    Label(main_window, font=("Segoe UI", 16, "bold"), text="Item Name:", bg="DeepSkyBlue2").grid(column=3, row=10, padx=1, pady=5) # Item Name Heading
    Label(main_window, font=("Segoe UI", 16, "bold"), text="Quantity Hired:", bg="DeepSkyBlue2").grid(column=4, row=10, padx=1, pady=5) # Quantity Hired Heading
...
def setup_buttons():
    ...
    Button(main_window, font=("Segoe UI", 16, "bold"), text="Print Details", bg='orange', bd=5, relief=RAISED, command=print_hired_item_details).grid(column=4, row=2, sticky=E, padx=5, pady=5)
    ...
    Button(main_window, font=("Segoe UI", 16, "bold"), text="History", bg='orange', bd=5, relief=RAISED, command=open_history_window).grid(column=4, row=5, sticky=E, padx=5, pady=5)
