#Date: 14/08/24
#Author: Jacky 
#Purpose: Button 2 - Flat Buttons with Border and Underline
...
def setup_buttons():
    ...
    # Flat Buttons with Border and Underline
    Button(main_window, font=("Arial", 10, "underline"), text="Submit", bg='orange', bd=5, relief=FLAT, highlightbackground='black', highlightthickness=2).grid(column=3, row=2, sticky=E, padx=5, pady=5)
    Button(main_window, font=("Arial", 10, "underline"), text="Quit", bg='orange', bd=5, relief=FLAT, highlightbackground='black', highlightthickness=2).grid(column=4, row=1, sticky=E, padx=5, pady=5)
    Button(main_window, font=("Arial", 10, "underline"), text="Print Details", bg='orange', bd=5, relief=FLAT, highlightbackground='black', highlightthickness=2).grid(column=4, row=2, sticky=E, padx=5, pady=5)
    Button(main_window, font=("Arial", 10, "underline"), text="Delete Row", bg='orange', bd=5, relief=FLAT, highlightbackground='black', highlightthickness=2).grid(column=4, row=4, sticky=E, padx=5, pady=5)
