...
def open_receipt_window():
    ...
    Label(receipt_window, font=("Segoe UI", 18, "bold"), text="Row #:", bg="#3CB371", anchor='center').grid(column=0, row=0, **heading_padding, sticky='ew')
    Label(receipt_window, font=("Segoe UI", 18, "bold"), text="Receipt #:", bg="#3CB371", anchor='center').grid(column=1, row=0, **heading_padding, sticky='ew')
    Label(receipt_window, font=("Segoe UI", 18, "bold"), text="Customer Full Name:", bg="#3CB371", anchor='center').grid(column=2, row=0, **heading_padding, sticky='ew')
    Label(receipt_window, font=("Segoe UI", 18, "bold"), text="Item Name:", bg="#3CB371", anchor='center').grid(column=4, row=0, **heading_padding, sticky='ew')
    Label(receipt_window, font=("Segoe UI", 18, "bold"), text="Quantity Hired:", bg="#3CB371", anchor='center').grid(column=6, row=0, **heading_padding, sticky='ew')

    # Check if there are items to display
    if hired_items:
        #Display each item in the Receipt Window
        for i, item in enumerate(hired_items):
            Label(receipt_window, font=("Segoe UI", 14, "bold"), text=str(i + 1), fg="black", bg="MediumSpringGreen", anchor='center').grid(column=0, row=i + 1, **heading_padding, sticky='ew')
            Label(receipt_window, font=("Segoe UI", 14, "bold"), text=item[3], fg="black", bg="MediumSpringGreen", anchor='center').grid(column=1, row=i + 1, **heading_padding, sticky='ew')
            Label(receipt_window, font=("Segoe UI", 14, "bold"), text=item[0], fg="black", bg="MediumSpringGreen", anchor='center').grid(column=2, row=i + 1, **heading_padding, sticky='ew')
            Label(receipt_window, font=("Segoe UI", 14, "bold"), text=item[1], fg="black", bg="MediumSpringGreen", anchor='center').grid(column=4, row=i + 1, **heading_padding, sticky='ew')
            Label(receipt_window, font=("Segoe UI", 14, "bold"), text=item[2], fg="black", bg="MediumSpringGreen", anchor='center').grid(column=6, row=i + 1, **heading_padding, sticky='ew')
