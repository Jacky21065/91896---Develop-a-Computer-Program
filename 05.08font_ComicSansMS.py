#Date: 05/08/24
#Author: Jacky 
#Purpose: Font Trial 2 - Comic Sans MS
...
def print_hired_item_details():
    ...
    Label(main_window, font=("comic sans ms", 10, "bold"), text="Row #", bg="Lawn Green").grid(column=0, row=10, padx=1, pady=5)  # Row Heading
    Label(main_window, font=("comic sans ms", 10, "bold"), text="Receipt Number:", bg="Lawn Green").grid(column=1, row=10, padx=1, pady=5) # Reciept Number Heading
    Label(main_window, font=("comic sans ms", 10, "bold"), text="Name:", bg="Lawn Green").grid(column=2, row=10, padx=1, pady=5) # Name Heading
    Label(main_window, font=("comic sans ms", 10, "bold"), text="Item Name:", bg="Lawn Green").grid(column=3, row=10, padx=1, pady=5) # Item Name Heading
    Label(main_window, font=("comic sans ms", 10, "bold"), text="Quantity Hired:", bg="Lawn Green").grid(column=4, row=10, padx=1, pady=5) # Quantity Hired Heading
...
def setup_buttons():
    ...
    Label(main_window, font=("comic sans ms", 10), text="Customer Full Name", bg='Khaki').grid(column=0, row=1, sticky=E)
    Label(main_window, font=("comic sans ms", 10), text="Item Name", bg='Khaki').grid(column=0, row=2, sticky=E)
    Label(main_window, font=("comic sans ms", 10), text="Quantity Hired", bg='Khaki').grid(column=0, row=3, sticky=E)
    Button(main_window, font=("comic sans ms", 10), text="Quit", bg='Khaki', command=quit, width=10).grid(column=4, row=1, sticky=E)
    Button(main_window, font=("comic sans ms", 10), text="Submit", bg='Khaki', command=check_inputs).grid(column=3, row=2, sticky=E)
    Button(main_window, font=("comic sans ms", 10), text="Print Details", bg='Khaki', command=print_hired_item_details, width=10).grid(column=4, row=2, sticky=E)
    Label(main_window, font=("comic sans ms", 10), text="Row #", bg='Khaki').grid(column=3, row=3, sticky=E)
