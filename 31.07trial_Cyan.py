#Date: 31/07/24
#Author: Jacky 
#Purpose: Colour Trial 1 - Cyan and Red
...
def print_hired_item_details():
    ...
    Label(main_window, font=("Segoe UI", 10, "bold"), text="Row #", bg='red').grid(column=0, row=10, padx=1, pady=5)  # Row Heading
    Label(main_window, font=("Segoe UI", 10, "bold"), text="Receipt Number:", bg='red').grid(column=1, row=10, padx=1, pady=5) # Reciept Number Heading
    Label(main_window, font=("Segoe UI", 10, "bold"), text="Name:", bg='red').grid(column=2, row=10, padx=1, pady=5) # Name Heading
    Label(main_window, font=("Segoe UI", 10, "bold"), text="Item Name:", bg='red').grid(column=3, row=10, padx=1, pady=5) # Item Name Heading
    Label(main_window, font=("Segoe UI", 10, "bold"), text="Quantity Hired:", bg='red').grid(column=4, row=10, padx=1, pady=5) # Quantity Hired Heading

    # Add each item in the list into its own row
    while name_count < counters['total_entries']:
        Label(main_window, text=str(name_count + 1), fg="black", bg="cyan").grid(column=0, row=name_count+11) # Row number
        Label(main_window, text=hired_items[name_count][3], fg="black", bg="cyan").grid(column=1, row=name_count+11) # Receipt Number
        Label(main_window, text=hired_items[name_count][0], fg="black", bg="cyan").grid(column=2, row=name_count+11) # Name
        Label(main_window, text=hired_items[name_count][1], fg="black", bg="cyan").grid(column=3, row=name_count+11) # Item Name
        Label(main_window, text=hired_items[name_count][2], fg="black", bg="cyan").grid(column=4, row=name_count+11) # Quantity Hired
        name_count += 1
