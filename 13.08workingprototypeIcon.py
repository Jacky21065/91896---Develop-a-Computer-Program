...
def main():
    ...
    # Set the window icon
    icon_image = PhotoImage(file=r'C:\Users\zhouj\OneDrive - Lynfield College\Documents\2PAD 2024\Jacky Zhou - 91897 and 91896 Assessment\Code Prototypes\After Checkpoint 1\Prototype\icon.png')  
...
def setup_buttons():
   ...
   # Load and place the bin icon next to the "Delete Row" button
    try:
        bin_icon_path = r'C:\Users\zhouj\OneDrive - Lynfield College\Documents\2PAD 2024\Jacky Zhou - 91897 and 91896 Assessment\Code Prototypes\After Checkpoint 1\Prototype\bin_icon.png'  # Use raw string for the path
