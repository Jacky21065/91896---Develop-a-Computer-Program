...
def open_receipt_window():
    ...
    Label(receipt_window, font=("Segoe UI", 18, "bold"), text="Row #:", bg="DeepSkyBlue2", anchor='center').grid(column=0, row=0, **heading_padding, sticky='ew')
    Label(receipt_window, font=("Segoe UI", 18, "bold"), text="Receipt #:", bg="DeepSkyBlue2", anchor='center').grid(column=1, row=0, **heading_padding, sticky='ew')
    Label(receipt_window, font=("Segoe UI", 18, "bold"), text="Customer Full Name:", bg="DeepSkyBlue2", anchor='center').grid(column=2, row=0, **heading_padding, sticky='ew')
    Label(receipt_window, font=("Segoe UI", 18, "bold"), text="Item Name:", bg="DeepSkyBlue2", anchor='center').grid(column=4, row=0, **heading_padding, sticky='ew')
    Label(receipt_window, font=("Segoe UI", 18, "bold"), text="Quantity Hired:", bg="DeepSkyBlue2", anchor='center').grid(column=6, row=0, **heading_padding, sticky='ew')

    # Check if there are items to display
    if hired_items:
        #Display each item in the Receipt Window
        for i, item in enumerate(hired_items):
            Label(receipt_window, text=str(i + 1), fg="black", bg="MediumSpringGreen", anchor='center').grid(column=0, row=i + 1, **heading_padding, sticky='ew')
            Label(receipt_window, text=item[3], fg="black", bg="MediumSpringGreen", anchor='center').grid(column=1, row=i + 1, **heading_padding, sticky='ew')
            Label(receipt_window, text=item[0], fg="black", bg="MediumSpringGreen", anchor='center').grid(column=2, row=i + 1, **heading_padding, sticky='ew')
            Label(receipt_window, text=item[1], fg="black", bg="MediumSpringGreen", anchor='center').grid(column=4, row=i + 1, **heading_padding, sticky='ew')
            Label(receipt_window, text=item[2], fg="black", bg="MediumSpringGreen", anchor='center').grid(column=6, row=i + 1, **heading_padding, sticky='ew')
