...
def open_receipt_window():
    ...
    Label(receipt_window, font=("Segoe UI", 18, "bold"), text="Row #:", bg="DeepSkyBlue2").grid(column=0, row=0, padx=1, pady=5)
    Label(receipt_window, font=("Segoe UI", 18, "bold"), text="Receipt #:", bg="DeepSkyBlue2").grid(column=1, row=0, padx=1, pady=5)
    Label(receipt_window, font=("Segoe UI", 18, "bold"), text="Customer Full Name:", bg="DeepSkyBlue2").grid(column=2, row=0, padx=1, pady=5)
    Label(receipt_window, font=("Segoe UI", 18, "bold"), text="Item Name:", bg="DeepSkyBlue2").grid(column=3, row=0, padx=1, pady=5)
    Label(receipt_window, font=("Segoe UI", 18, "bold"), text="Quantity Hired:", bg="DeepSkyBlue2").grid(column=4, row=0, padx=1, pady=5)

    # Display each item in the Receipt window
    for i, item in enumerate(hired_items):
        Label(receipt_window, text=str(i + 1), fg="black", bg="MediumSpringGreen").grid(column=0, row=i+1)
        Label(receipt_window, text=item[3], fg="black", bg="MediumSpringGreen").grid(column=1, row=i+1)
        Label(receipt_window, text=item[0], fg="black", bg="MediumSpringGreen").grid(column=2, row=i+1)
        Label(receipt_window, text=item[1], fg="black", bg="MediumSpringGreen").grid(column=3, row=i+1)
        Label(receipt_window, text=item[2], fg="black", bg="MediumSpringGreen").grid(column=4, row=i+1)
